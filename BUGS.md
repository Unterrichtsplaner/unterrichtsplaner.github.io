...
- [ ] **X1** 🟠 **iPad: App schwebt als Karte mit schwarzen Rändern, bis zu einem Drittel des Bildschirms bleibt leer** (style.css Z. 55: `#app{max-width:1180px; max-height:820px; border-radius:12px; box-shadow…}`): 768×1024 (iPad hochkant) → App 820 px hoch, oben/unten je ~100 px schwarz; iPad Air hochkant (820×1180) → 360 px schwarz; iPad Pro 12,9″ quer (1366×1024) → 1180×820 mittig im Schwarzen. Das iPad ist das Hauptgerät. *Browser.* → Rahmen nur für große Desktop-Fenster (`@media (hover:hover) and (pointer:fine)`) oder ganz weglassen; auf Touch-Geräten volle Fläche.
